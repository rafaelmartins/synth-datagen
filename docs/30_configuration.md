...
The `parameters` map is checked before `global_parameters` during parameter resolution. See [DSP modules](20_modules.md) for detailed documentation of each module's selectors and parameters.
